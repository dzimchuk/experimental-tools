...
{
    [ExportCodeRefactoringProvider(LanguageNames.CSharp, Name = nameof(ExperimentalToolsCodeRefactoringProvider)), Shared]
    internal class ExperimentalToolsCodeRefactoringProvider : CodeRefactoringProvider
    {
